...
# 带详细输出和版本号
python flet_build.py windows --verbose --build-version=0.0.16-beta --build-number=42
...
| `--build-version` | 版本号 | `--build-version=0.0.16-beta` |
...
# CI 环境构建
python flet_build.py windows --verbose --no-rich-output --yes --build-version=0.0.16-beta --build-number=123
